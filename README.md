...
A [prebuilt OSX binary](jag.macOS.dmg?raw=true) and [prebuilt linux x86_64 binary](jag.linux.x86_64?raw=true) called jag (for *J*avelin *AG*) are included for convenience.
