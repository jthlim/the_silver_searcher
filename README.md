...
A [prebuilt OSX binary](raw/master/jag.macOS.dmg) and [prebuilt linux x86_64 binary](raw/master/jag.linux.x86_64) called jag (for *J*avelin *AG*) are included for convenience.
